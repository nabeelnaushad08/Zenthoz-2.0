      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full flex items-center justify-between">
          <Link href="/" className="flex-shrink-0">
            <span className="text-2xl font-black tracking-tight gradient-text">ZENTHOZ</span>
          </Link>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ zIndex: 40 }}
            className="fixed inset-0 bg-[#0a0a0a] flex flex-col items-center justify-center lg:hidden"
          >
            <nav className="flex flex-col items-center gap-8">
              ...
              <Link
                href="/contact"
                className="mt-4 inline-flex items-center px-8 py-4 rounded-full text-lg font-semibold text-white bg-gradient-to-r from-violet-600 via-fuchsia-500 to-cyan-400"
              >
                Start a Project
              </Link>
            </nav>
